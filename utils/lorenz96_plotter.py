#############################################################
# This code was taken from Prof. Kavassalis' L96 notebook,  #
# found here: http://kavassalis.space/s/Lorenz96_plotter.py #
#############################################################
...
def plot_Lorenz96(time_series, lat_plot, X, t, F, K, n_samples, time_resolution, global_avg=False, extra_ts_plots=False, mean=True, median=False, ensemoff=False, twoD_latplot = False, label_lead='', base_colour=True):
    ...
    number_of_days = n_samples / (time_resolution / 5) / 5
    tplot=t
    ...
    if is_atmos_and_ocean == True:
        ...
        plot_Lorenz96(time_series, lat_plot, X_ocean, t, F, K, n_samples, time_resolution, global_avg, extra_ts_plots, mean, median, ensemoff, twoD_latplot, label_lead = 'Second ', base_colour = False)
